    ...
    return (
        <Paper className={classes.paper}>
            <form autoComplete="off" noValidate className={`${classes.root} ${classes.form}`} onSubmit={handleSubmit}>
                <Typography variant="h6">{currentId?`Editing`:`Creating`} a Journal</Typography>
                ...
                <Button  variant="contained" size="large" onClick={clear} color="secondary" fullWidth>Clear</Button>
